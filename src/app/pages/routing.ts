...
const Routing: Routes = [
  ...
  {
    path: 'excel',
    loadChildren:()=>import('../modules/excel-parser/excel-parser.module').then((m) =>m.ExcelParserModule)
  },
  {
    path: 'csv',
  ...
  {
    path: 'reports',
    loadChildren:()=>import('../modules/home/reports/reports.module').then(m=>m.ReportsModule)
  },
  {
    path: 'termination',
